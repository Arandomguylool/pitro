...
class ModchartState 
{
	...
	{
		#if sys
		var data:BitmapData = BitmapData.fromFile(Asset2File.getPath() + "assets/data/" + PlayState.SONG.song.toLowerCase() + '/' + spritePath + ".png");

		var sprite:FlxSprite = new FlxSprite(0,0);

		sprite.frames = FlxAtlasFrames.fromSparrow(FlxGraphic.fromBitmapData(data), Asset2File.getPath() + "assets/data/" + PlayState.SONG.song.toLowerCase() + "/" + spritePath + ".xml");
    ...
    function new()
    {
				...
				var result = LuaL.dostring(lua, openfl.utils.Assets("assets/data/" + PlayState.SONG.song.toLowerCase() + "/modchart.lua")); // execute le file
