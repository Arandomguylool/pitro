...
class ModchartState 
{
	...
	{
		#if sys
		var data:BitmapData = BitmapData.fromFile(Asset2File.path + "assets/data/" + PlayState.SONG.song.toLowerCase() + '/' + spritePath + ".png");

		var sprite:FlxSprite = new FlxSprite(0,0);

		sprite.frames = FlxAtlasFrames.fromSparrow(FlxGraphic.fromBitmapData(data), Asset2File.path + "assets/data/" + PlayState.SONG.song.toLowerCase() + "/" + spritePath + ".xml");
